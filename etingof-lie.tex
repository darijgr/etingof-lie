...
%TCIDATA{LastRevised=Monday, March 12, 2012 21:55:12}
...
\textit{pseudo-}$\mathfrak{g}$\textit{ polynomial terms}. This is more or less
an upgraded notion of a polynomial, which we will use to formalize what it
means for two expressions in $M_{\lambda}^{+\mathfrak{g}^{\varepsilon}}$ to be
"equal up to $\varepsilon$ times an expression which is formed in the same way
for every $\varepsilon$" (we cannot really talk of an element in $M_{\lambda
...
\begin{definition}
Let $m\in\mathbb{N}$. Let $E$ be a variable symbol. Let $L$ be a function
symbol (of one argument). In the following, a \textit{term} will denote a term
using symbols from the set%
\[
\mathbb{C}\cup\mathfrak{g}\cup\left\{  L\right\}  \cup\left\{  E\right\}
\cup\left\{  +,\cdot,\left[  \cdot,\cdot\right]  \right\}  ,
\]
...
also allowed, but serve no other purpose than disambiguation.

\textbf{(a)} Let $\operatorname*{psLie}\nolimits_{\mathbb{C}}$ and
$\operatorname*{psLie}\nolimits_{\mathfrak{g}}$ be two sets of terms defined
recursively as follows:

- The symbols in $\mathbb{C}$ are elements of $\operatorname*{psLie}%
\nolimits_{\mathbb{C}}$.

- The symbols in $\mathfrak{g}$ are elements of $\operatorname*{psLie}%
\nolimits_{\mathfrak{g}}$.

- The variable $E$ is an element of $\operatorname*{psLie}%
\nolimits_{\mathbb{C}}$.

- For every $t\in\operatorname*{psLie}\nolimits_{\mathfrak{g}}$, the term
$L\left(  t\right)  $ is in $\operatorname*{psLie}\nolimits_{\mathbb{C}}$.

- For every $p$ and $q$ in $\operatorname*{psLie}\nolimits_{\mathbb{C}}$, each
of $p+q$ and $pq$ belongs to $\operatorname*{psLie}\nolimits_{\mathbb{C}}$.

- For every $p$ and $q$ in $\operatorname*{psLie}\nolimits_{\mathfrak{g}}$,
each of $p+q$ and $\left[  p,q\right]  $ belongs to $\operatorname*{psLie}%
\nolimits_{\mathfrak{g}}$.

- For every $p\in\operatorname*{psLie}\nolimits_{\mathbb{C}}$ and
$q\in\operatorname*{psLie}\nolimits_{\mathfrak{g}}$, we have $pq\in
\operatorname*{psLie}\nolimits_{\mathfrak{g}}$.

We denote the elements of $\operatorname*{psLie}\nolimits_{\mathbb{C}}$ as
\textit{pseudo-}$\mathfrak{g}$\textit{ polynomial terms of type }$\mathbb{C}$.
We denote the elements of $\operatorname*{psLie}\nolimits_{\mathbb{C}}$ as
\textit{pseudo-}$\mathfrak{g}$\textit{ polynomial terms of type }%
$\operatorname*{Lie}$.

\textbf{(b)} Furthermore, we define a set $\operatorname*{psLie}%
\nolimits_{U\left(  \mathfrak{g}\right)  }$ recursively as follows:

- Every element of $\operatorname*{psLie}\nolimits_{\mathfrak{g}}$ and every
element of $\operatorname*{psLie}\nolimits_{\mathbb{C}}$ is an element of
$\operatorname*{psLie}\nolimits_{U\left(  \mathfrak{g}\right)  }$.

- For any $p$ and $q$ in $\operatorname*{psLie}\nolimits_{U\left(
\mathfrak{g}\right)  }$, each of $p+q$ and $pq$ belongs to
$\operatorname*{psLie}\nolimits_{U\left(  \mathfrak{g}\right)  }$.

We denote the elements of $\operatorname*{psLie}\nolimits_{U\left(
\mathfrak{g}\right)  }$ as \textit{pseudo-}$\mathfrak{g}$\textit{ polynomial
terms of type }$U\left(  \mathfrak{g}\right)  $.
\end{definition}

\begin{definition}
Let $m\in\mathbb{N}$. Let $\mathfrak{g}$ be a $\mathbb{Z}$-graded Lie algebra.
Let $\lambda\in\mathfrak{g}_{0}^{\ast}$. Let $\varepsilon\in\mathbb{C}$.

Let $p$ be a pseudo-$\mathfrak{g}$ polynomial term of any type, i. e., an
element of either of the sets $\operatorname*{psLie}\nolimits_{\mathbb{C}}$,
$\operatorname*{psLie}\nolimits_{\mathfrak{g}}$ and $\operatorname*{psLie}%
\nolimits_{U\left(  \mathfrak{g}\right)  }$. Then, the \textit{evaluation of
}$p$ \textit{at }$\left(  \lambda,\varepsilon\right)  $ will mean the result
of replacing each occurence of $L$ in $p$ by $\lambda$, replacing each
occurence of $E$ in $p$ by $\varepsilon$, and evaluating the resulting term in
the usual meaning of this word. We denote the evaluation of $p$ at $\left(
\lambda,\varepsilon\right)  $ by $p\left(  \lambda,\varepsilon\right)  $. If
$p\in\operatorname*{psLie}\nolimits_{\mathbb{C}}$, then $p\left(
\lambda,\varepsilon\right)  \in\mathbb{C}$. If $p\in\operatorname*{psLie}%
\nolimits_{\mathfrak{g}}$, then $p\left(  \lambda,\varepsilon\right)
\in\mathfrak{g}^{\varepsilon}$. If $p\in\operatorname*{psLie}%
\nolimits_{U\left(  \mathfrak{g}\right)  }$, then $p\left(  \lambda
,\varepsilon\right)  \in U\left(  \mathfrak{g}^{\varepsilon}\right)  $.

If $p\in\operatorname*{psLie}\nolimits_{\mathbb{C}}$ or $p\in
\operatorname*{psLie}\nolimits_{\mathfrak{g}}$, then the evaluation $p\left(
\lambda,\varepsilon\right)  $ depends polynomially on $\lambda$ and
$\varepsilon$. (This cannot be said in the case $p\in\operatorname*{psLie}%
\nolimits_{U\left(  \mathfrak{g}\right)  }$ because 
\end{definition}
